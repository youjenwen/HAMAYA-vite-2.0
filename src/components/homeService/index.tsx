    ...
    <>
      {direction ? (
            ...
            <div className="relative h-[180px] w-[700px]">
              <div className="absolute top-0 bottom-0 -left-16 my-auto mx-0 h-[90px] w-[700px] bg-primary-beige/50">
                <div className="relative">
                  ...
                  <span className="absolute left-1/3 top-14  whitespace-nowrap text-heading_4 text-primary-beige">
                    {enTitle}
                  </span>
                </div>
              </div>
        ...
        <div className="mt-8">
          <div className="items-center justify-center md:flex">
            <div className="relative md:h-[180px] md:w-[700px]">
              <div className="absolute z-10 my-auto mx-0 h-[90px] w-[700px] bg-primary-beige/50 max-md:top-[45px] md:top-0 md:bottom-0 md:left-16">
                <div className="relative">
